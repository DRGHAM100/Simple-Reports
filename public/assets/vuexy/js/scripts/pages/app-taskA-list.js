...
$(function () {
    ...
    if (dtUserTable.length) {
        oTable = dtUserTable.DataTable({
            ...
            ajax: assetPath + '/tasks/all/all', // JSON file to add data
            "columns": [
                {
                    orderable: false,
                    'searchable': false,
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        return (
                            ...
                            '<a href="#editModal" data-toggle="modal" pull-link="../tasks/' +
                            $id + '/edit' +
                            '" class="dropdown-item" id="edit_btn">' +
                            feather.icons['archive'].toSvg({class: 'font-small-4 mr-50'}) +
                            'تعديل</a>' +
                            '<a href="../tasks/'+$id+'"  pull-link="' +
                            $id +
                            '" class="dropdown-item" id="show_btn">' +
                            feather.icons['eye'].toSvg({class: 'font-small-4 mr-50'}) +
                            'عرض</a>' +
                            '<a href="../tasks/' + $id + '" class="dropdown-item delete-record" id="delete_btn"> ' +
            ...
            buttons: [
                ...
                {
                    text: ' تنبيه المهام المتأخره',
                    className: 'notifi btn btn-warning mt-50',
                    init: function (api, node, config) {
