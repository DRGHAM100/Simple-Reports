...
$(function () {
 ...
 // Users List datatable
  if (dtUserTable.length) {
      ...
      ajax: assetPath + '/driver/all', // JSON file to add data
        "columns": [
            {
                orderable: false,
                'searchable': false,
      ...
      columnDefs: [
        ...
        // },
        {
          ...
          render: function (data, type, full, meta) {
              ...
              '<a href="#editModal" data-toggle="modal" pull-link="driver/' +
              $id +'/edit'+
              '" class="dropdown-item" id="edit_btn">' +
              feather.icons['archive'].toSvg({ class: 'font-small-4 mr-50' }) +
              'تعديل</a>' +
              '<a href="driver/'+$id+'" class="dropdown-item delete-record" id="delete_btn"> ' +
