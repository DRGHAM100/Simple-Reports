...
(function (window, document, $) {
  ...
  $.app.menu = {
    ...
    manualScroller: {
      ...
      init: function () {
        ...
        if (!$.app.menu.is_touch_device()) {
          this.obj = new PerfectScrollbar('.main-menu', {
      ...
      update: function () {
        ...
        if ($('.main-menu').data('scroll-to-active') === true) {
          ...
          activeEl = document.querySelector('.main-menu li.active');
          menu = document.querySelector('.main-menu');
          if ($body.hasClass('menu-collapsed')) {
            if ($('.main-menu li.sidebar-group-active').length) {
              activeEl = document.querySelector('.main-menu li.sidebar-group-active');
            }
          }
          if (activeEl) {
    ...
    change: function (compactMenu) {
      ...
      if (currentBreakpoint.name == 'xl') {
        $('body[data-open="hover"] .main-menu .dropdown') // Use selector $('body[data-open="hover"] .header-navbar .dropdown') for menu and navbar DD open on hover
      ...
      if (currentBreakpoint.name == 'xl' && menuType == 'horizontal-menu') {
        $('.main-menu').find('li.active').parents('li').addClass('sidebar-group-active active');
      }
        ...
        this.transit(
          ...
          function () {
            ...
            if (
              ...
              $('.main-menu').css('height', $(window).height() - $('.header-navbar').height());
              // this.manualScroller.update();
            }
            if ($body.data('menu') == 'vertical-menu-modern') {
              if ($('.main-menu').hasClass('menu-fixed')) this.manualScroller.enable();
    ...
    changeMenu: function (screen) {
      ...
      if (screen === 'xl') {
        ...
        $('.main-menu').find('li.active').parents('li').addClass('sidebar-group-active');

        $('.main-menu').find('li.active').closest('li.nav-item').addClass('open');
      }
  ...
  $.app.nav = {
      ...
      $('.navigation-main')
        .on('mouseenter.app.menu', 'li', function () {
          ...
          if ($body.hasClass('menu-collapsed') && $body.data('menu') != 'vertical-menu-modern') {
            $('.main-menu').children('span.menu-title').remove();
            $('.main-menu').children('a.menu-title').remove();
            $('.main-menu').children('ul.menu-content').remove();
            ...
            if ($body.data('menu') !== 'vertical-compact-menu') {
              menuTitle.appendTo('.main-menu').css({
                position: 'fixed',
                top: fromTop
              });
            }
        ...
        if ($body.data('menu') == 'vertical-menu-modern') {
          ...
          if ($body.hasClass('menu-collapsed')) {
            if ($('.main-menu li.open').length === 0) {
              $('.main-menu').find('li.active').parents('li').addClass('open');
            }
    ...
    /* adjustSubmenu: function ($menuItem) {
      ...
      ul.addClass('menu-popout').appendTo('.main-menu').css({
        top: topPos,
        position: 'fixed',
        'max-height': popOutMenuHeight
      });

      var menu_content = new PerfectScrollbar('.main-menu > ul.menu-content', {
        wheelPropagation: false
      });
    }, */
