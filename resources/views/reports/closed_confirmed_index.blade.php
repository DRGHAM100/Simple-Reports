                    ...
                    <div class="card shadow mb-2">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">
                                <a class="btn" data-toggle="modal12" data-target="#exampleModal12" style="font-weight:bold;float:right;font-size:1.2rem">  جدول البلاغات المغلقة مع الإفادة</a>
                            </h6>
                        </div>
                        <div class="card-body">
  ...
  <script type="text/javascript">
    $(function () {
        ...
        var table = $('.yajra-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('reports.data',['type' => 'closed-confirmed']) }}", 
            columns: [
                {data: 'id', name: 'id'},
